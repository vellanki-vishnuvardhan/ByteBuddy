...
/**
 * Servlet implementation class Displayanswerservletc
 */
@WebServlet("/DisplayAnswersServletsql")
public class Displayanswerservletsql extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, username, password)) {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM sqlquiz_questions");
