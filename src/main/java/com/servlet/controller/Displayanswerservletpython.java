...
/**
 * Servlet implementation class Displayanswerservletpython
 */
@WebServlet("/Displayanswerservletpython")
public class Displayanswerservletpython extends HttpServlet 
{
